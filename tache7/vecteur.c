...
int main()
{
    vector_int v = creer_vector_int();
    vector_int v2 = creer_vector_int();
    ajouter_fin_int(&v, 42);
    ajouter_fin_int(&v, 43);
    ajouter_fin_int(&v, 45);
    ajouter_fin_int(&v2, 46);
    ajouter_fin_int(&v2, 47);
    concatenation_int(&v, &v2);
    supprimer_premier_element_int(&v);
